...
4. When creating an appointment, you'll invite other users to the same appointment. There are a list of other users also on the database that you can invite, for this purpose. However, note that if your timezone is too drastically different from that user's (9 or more hours away from their timezone), you may not have any available times left for the appointment.
